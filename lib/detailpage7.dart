...
class DetailPage7 extends StatefulWidget {
  const DetailPage7({super.key});

  @override
  State<DetailPage7> createState() => _DetailPage7State();
}
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: [
          ...
          Row(
            children: [
              ...
              Column(
                children: [
                  Text(
                    "[" + prov.menu['data'][6]['rating'].toString() + "]",
                  )
                ],
              )
            ],
          ...
          Row(
            children: [Image.asset(prov.menu['data'][6]['img'])],
          ),
          Row(
            children: [
              Column(
          ...
          Padding(
            ...
            child: Text(prov.menu['data'][6]['nama'],
                style: TextStyle(fontSize: 10)),
          ),
          Padding(
              padding: const EdgeInsets.only(top: 10, left: 10),
              child: Text(
                prov.menu['data'][6]['deskripsi'],
              )),
          Column(
