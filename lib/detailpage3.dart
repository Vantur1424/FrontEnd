    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: [
          ...
          Row(
            children: [
              ...
              Column(
                children: [
                  Text(
                    "[" + prov.menu['data'][2]['rating'].toString() + "]",
                  )
                ],
              )
            ],
          ...
          Row(
            children: [Image.asset(prov.menu['data'][2]['img'])],
          ),
          Row(
            children: [
              Column(
              ...
              Column(
                children: [
                  Text(
                    prov.menu['data'][2]['harga'].toString(),
                  )
                ],
              )
            ],
          ...
          Padding(
            ...
            child: Text(prov.menu['data'][2]["ukuran"],
                style: TextStyle(fontSize: 50)),
          ),
          Padding(
            padding: EdgeInsets.only(top: 10, left: 10),
            child: Text(prov.menu['data'][2]['nama'],
                style: TextStyle(fontSize: 10)),
          ),
          Padding(
              padding: const EdgeInsets.only(top: 10, left: 10),
              child: Text(
                prov.menu['data'][2]['deskripsi'],
              )),
          Column(
