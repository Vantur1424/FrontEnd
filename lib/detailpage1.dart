      ...
      body: Padding(
        ...
        child: ListView(children: [
          ...
          Padding(
            ...
            child: Text(prov.menu['data'][0]['subtitle'],
            ...
            children: [
              Column(
                children: [
                  RatingBarIndicator(
                    rating:
                        double.parse(prov.menu['data'][0]['rating'].toString()),
              ...
              Column(
                children: [
                  Text(
                    "[" + prov.menu['data'][0]['rating'].toString() + "]",
                  )
                ],
              )
            ],
          ...
          Row(
            children: [Image.asset(prov.menu['data'][0]['img'])],
          ),
          Row(
            children: [
              Column(
          ...
          Padding(
            ...
            child: Text(prov.menu['data'][0]["ukuran"],
                style: TextStyle(fontSize: 50)),
          ),
          Padding(
            padding: EdgeInsets.only(top: 10, left: 10),
            child: Text(prov.menu['data'][0]['nama'],
                style: TextStyle(fontSize: 10)),
          ),
          Padding(
              padding: const EdgeInsets.only(top: 10, left: 10),
              child: Text(
                prov.menu['data'][0]['deskripsi'],
              )),
          Column(
